...
from src.ratings.serializers import RatingSerializer
...
class ProfileSerializer(serializers.ModelSerializer):
  ...
  class Meta:
    model = Profile
    fields = [
      'full_name', 'username', 'first_name', 'last_name', 'email', 'id', 'phone_number', 'profile_photo', 'about_me', 'license', 'gender', 'country', 'city', 'is_buyer', 'is_seller', 'is_agent', 'rating', 'num_reviews', 'reviews']
